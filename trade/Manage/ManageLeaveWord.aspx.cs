...
{
    public partial class ManageLeaveWord : System.Web.UI.Page
    {
        ...
        protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
        {
            ...
            {
                int wordid = int.Parse(e.CommandArgument.ToString());
                Response.Write("<script>window.open('ReplyLeaveWord.aspx?WordID=" + wordid + "')</script>");
            }
